...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'LaFamiglia808 | Studio di Produzione'); ?></title>
...
<header id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300" style="background: rgba(10,10,10,0.85); backdrop-filter: blur(16px); border-bottom: 1px solid #1A1A1A;">
    <nav class="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <div class="hidden md:flex items-center gap-8">
            ...
            <a href="<?php echo e(route('services')); ?>" class="nav-link <?php echo e(request()->routeIs('services') ? 'active' : ''); ?>">Servizi</a>
            <a href="<?php echo e(route('portfolio')); ?>" class="nav-link <?php echo e(request()->routeIs('portfolio') ? 'active' : ''); ?>">Portfolio</a>
            <a href="<?php echo e(route('about')); ?>" class="nav-link <?php echo e(request()->routeIs('about') ? 'active' : ''); ?>">Chi Siamo</a>
            <a href="<?php echo e(route('pricing')); ?>" class="nav-link <?php echo e(request()->routeIs('pricing') ? 'active' : ''); ?>">Prezzi</a>
            <a href="<?php echo e(route('booking')); ?>" class="nav-link <?php echo e(request()->routeIs('booking') ? 'active' : ''); ?>">Booking</a>
            <a href="<?php echo e(route('contact')); ?>" class="btn-red text-xs">Contattaci</a>
        </div>
    ...
    <div id="mobileMenu" class="hidden md:hidden px-6 pb-6 flex flex-col gap-4" style="border-top: 1px solid #1A1A1A;">
        <a href="<?php echo e(route('home')); ?>" class="nav-link py-2">Home</a>
        <a href="<?php echo e(route('services')); ?>" class="nav-link py-2">Servizi</a>
        <a href="<?php echo e(route('portfolio')); ?>" class="nav-link py-2">Portfolio</a>
        <a href="<?php echo e(route('about')); ?>" class="nav-link py-2">Chi Siamo</a>
        <a href="<?php echo e(route('pricing')); ?>" class="nav-link py-2">Prezzi</a>
        <a href="<?php echo e(route('booking')); ?>" class="nav-link py-2">Booking</a>
        <a href="<?php echo e(route('contact')); ?>" class="btn-red text-center mt-2">Contattaci</a>
    </div>
</header>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <?php $__currentLoopData = [['home','Home'],['services','Servizi'],['portfolio','Portfolio'],['pricing','Prezzi'],['booking','Booking'],['about','Chi Siamo'],['contact','Contatti']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e(route($link[0])); ?>" class="text-sm hover:text-red-600 transition-colors" style="color:#888;"><?php echo e($link[1]); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between pt-8" style="border-top: 1px solid #1A1A1A;">
            <p class="font-mono text-xs" style="color:#444;">© <?php echo e(date('Y')); ?> LaFamiglia808. All rights reserved.</p>
            <a href="<?php echo e(route('admin.login')); ?>" class="font-mono text-xs mt-4 md:mt-0 hover:text-red-600 transition-colors" style="color:#333;">[ admin ]</a>
        </div>
    </div>
</footer>
...
<?php /**PATH /Applications/MAMP/htdocs/lafamiglia808/resources/views/layouts/app.blade.php ENDPATH**/ ?>