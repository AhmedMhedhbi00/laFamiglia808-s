<?php $__env->startSection('title', 'Prezzi | LaFamiglia808'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
        ...
        <div class="card-hover p-10 flex flex-col" style="background:#111;">
            ...
            <ul class="space-y-3 mb-10 flex-1">
                <?php $__currentLoopData = ['1 Beat personalizzato','2 revisioni incluse','File WAV + MP3','Consegna in 5 giorni','Licenza per uso non commerciale']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-center gap-3 text-sm" style="color:#ccc;">
                    <span class="text-red-600 flex-shrink-0">→</span><?php echo e($feat); ?>

                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
            <a href="<?php echo e(route('booking')); ?>" class="btn-outline text-center">Prenota →</a>
        </div>
        ...
        <div class="p-10 flex flex-col relative overflow-hidden" style="background:#DC2626; border:1px solid #DC2626;">
            ...
            <ul class="space-y-3 mb-10 flex-1">
                <?php $__currentLoopData = ['3 Beat personalizzati','Revisioni illimitate','Mixing professionale','File multitracking','Consegna in 7 giorni','Licenza commerciale completa','Supporto WhatsApp diretto']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-center gap-3 text-sm text-white">
                    <span style="color:rgba(255,255,255,.7);" class="flex-shrink-0">→</span><?php echo e($feat); ?>

                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
            <a href="<?php echo e(route('booking')); ?>" class="text-center py-3 font-mono text-xs tracking-widest uppercase bg-white text-red-600 hover:bg-gray-100 transition-colors block">Prenota →</a>
        </div>
        ...
        <div class="card-hover p-10 flex flex-col" style="background:#111;">
            ...
            <ul class="space-y-3 mb-10 flex-1">
                <?php $__currentLoopData = ['8h in studio','Tecnico del suono dedicato','Registrazione + Mixing','Mastering incluso','Beat personalizzati illimitati','File in tutti i formati','Licenza commerciale totale','Follow-up post-sessione']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-center gap-3 text-sm" style="color:#ccc;">
                    <span class="text-red-600 flex-shrink-0">→</span><?php echo e($feat); ?>
    ...
    <div class="mb-24">
        ...
        <div class="space-y-3">
            ...
            <div class="flex items-center justify-between p-6 card-hover" style="background:#111;">
                <div>
                    <h3 class="text-white font-semibold mb-1"><?php echo e($service->title); ?></h3>
                    <p class="text-sm" style="color:#888;"><?php echo e(Str::limit($service->description, 80)); ?></p>
                </div>
                <div class="text-right flex-shrink-0 ml-8">
                    <?php if($service->price): ?>
                    <div class="font-mono text-lg text-red-600"><?php echo e($service->price); ?></div>
                    <?php endif; ?>
                    <a href="<?php echo e(route('booking')); ?>" class="font-mono text-xs text-red-600 hover:text-red-500 transition-colors">Prenota →</a>
                </div>
            </div>
        ...
        <div class="space-y-4" x-data="{open: null}">
            ...
            <div class="card-hover" style="background:#111;" x-data="{open: false}">
                <button @click="open = !open" class="w-full flex items-center justify-between p-6 text-left">
                    <span class="text-white font-medium"><?php echo e($faq[0]); ?></span>
                    <span class="text-red-600 font-mono text-lg flex-shrink-0 ml-4" x-text="open ? '−' : '+'"></span>
                </button>
                <div x-show="open" x-collapse class="px-6 pb-6">
                    <p class="text-sm leading-relaxed" style="color:#888;"><?php echo e($faq[1]); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<section class="py-20 px-6 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div class="flex flex-wrap gap-4 justify-center">
            <a href="<?php echo e(route('contact')); ?>" class="inline-block px-10 py-4 font-mono text-sm tracking-widest uppercase bg-white text-red-600 hover:bg-gray-100 transition-colors">Contattaci</a>
            <a href="<?php echo e(route('booking')); ?>" class="btn-outline" style="border-color:rgba(255,255,255,.3);color:#fff;">Prenota Ora →</a>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/lafamiglia808/resources/views/public/pricing.blade.php ENDPATH**/ ?>