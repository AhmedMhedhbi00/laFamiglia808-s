<?php $__env->startSection('title', 'Chi Siamo | LaFamiglia808'); ?>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="card-hover p-8" style="background:#111;">
                <span class="font-display text-5xl text-red-600 block mb-6" style="opacity:0.5;"><?php echo e($v[0]); ?></span>
                <h3 class="font-display text-2xl text-white mb-4"><?php echo e($v[1]); ?></h3>
                <p class="text-sm leading-relaxed" style="color:#888;"><?php echo e($v[2]); ?></p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <div class="space-y-4">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $gear): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($i % 2 === 0): ?>
                    <div class="flex items-center gap-4 py-3" style="border-bottom: 1px solid #1A1A1A;">
                        <span class="font-mono text-xs tracking-widest uppercase w-28" style="color:#444;"><?php echo e($gear); ?></span>
                    <?php else: ?>
                        <span class="text-sm text-white flex-1"><?php echo e($gear); ?></span>
                    </div>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<section class="py-24 px-6" style="background:#0D0D0D;">
    <div class="max-w-4xl mx-auto text-center">
        ...
        <a href="<?php echo e(route('contact')); ?>" class="btn-red">Contattaci Ora</a>
    </div>
</section>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/lafamiglia808/resources/views/public/about.blade.php ENDPATH**/ ?>